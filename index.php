...
<a href="loginregister.php"><span style="font-size:18px; color:Green; font-weight:bold"><i class="fa fa-plus"></i></span></a>&nbsp&nbsp
<div class="dropdown">
  <a href="#"class="dropbtn"><i class="fa fa-fw fa-user"></i></a>&nbsp&nbsp
  <div class="dropdown-content">
    <a href="loginregister.php"><span style="color:blue; font-size:16px; font-weight:bold">&nbsp&nbsp&nbsp&nbsp Login</span></a>
    <hr>
    <p style="color:black; font-size:15px">&nbsp&nbsp Not a Member??<p>
    <a href="loginregister.php"><span style="color:red; font-size:16px; font-weight:bold">&nbsp&nbsp&nbsp&nbsp Register</span></a>
  </div>
</div>
<?php
...
?>
<div class="cart_div">
<a href="loginregister.php"><img src="images/cart-icon.png" /><span><?php echo $cart_count; ?></span></a>
<?php
}
?>
</div>
...
<br><br>
<h4><center>Welcome</h4></center> 
<center><a href="loginregister.php" style="color:Blue">Login</a></center>
</div>
<br>

  <a href="loginregister.php">My Cart</a>
  <a href="loginregister.php">Chat</a>
  <a href="loginregister.php">Book Shops Near Me</a>
  <a href="loginregister.php">Advertisement</a>
  <a href="loginregister.php">Talent Showcase</a>
  <a href="loginregister.php">Play Quiz</a>
  <a href="loginregister.php">Sell Books</a>
  <a href="loginregister.php">Add Your Advertisement</a>
  <a href="loginregister.php">Give Feedback</a>
</div>
</div>
</div>
</div>
...
<div class="container1">
<h3>INFORMATION</h3>
<p>> <a href="loginregister.php" class="f">About Us</a></p>
<p>> <a href="loginregister.php" class="f">Sell Your Book</a></p>
<p>> <a href="loginregister.php" class="f">Customer Feedbacks</a></p>
<p>> <a href="loginregister.php" class="f">Terms & Conditions</a></p>
<p>> <a href="loginregister.php" class="f">Rate Our Website</a></p>
<p>> <a href="loginregister.php" class="f">Add Your Advertisement</a></p>
<p>> <a href="loginregister.php" class="f">Give Feedback</a></p>
</div></div></div>
